...
from ros2_snapshot.core.utilities.utility import (
...
class ROSModel:
    ...
    BANK_TYPES_TO_BANK_CLASS = {
        BankType.NODE: metamodels.NodeBank,
        BankType.TOPIC: metamodels.TopicBank,
        BankType.ACTION: metamodels.ActionBank,
        BankType.SERVICE: metamodels.ServiceBank,
        BankType.PARAMETER: metamodels.ParameterBank,
